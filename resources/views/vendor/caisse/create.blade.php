  ...
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('caisse.store') }}" novalidate>
        ...
        <div class="form-row mb-3">
            <div class="col-md-6">
                <label for="validationCustom001" class="form-label">Nom du caissier <span style="color:red">*</span></label>
            ...
            <div class="col-md-6">
                <label for="validationCustom002" class="form-label">Prénoms du caissier<span style="color:red">*</span></label>
